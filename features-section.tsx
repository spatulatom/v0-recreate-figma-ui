    ...
    <section className="w-full py-20 bg-white">
      <div className="container px-4 md:px-6 mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-[#212529] text-4xl font-bold mb-4">Our Features</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-bold text-[#212529] mb-3">Document Collaboration</h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-bold text-[#212529] mb-3">Team Workspaces</h3>
            <p className="text-gray-600 mb-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-bold text-[#212529] mb-3">Advanced Security</h3>
            <p className="text-gray-600 mb-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-bold text-[#212529] mb-3">Smart Notifications</h3>
            <p className="text-gray-600 mb-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-bold text-[#212529] mb-3">Analytics Dashboard</h3>
            <p className="text-gray-600 mb-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-bold text-[#212529] mb-3">Automation Tools</h3>
            <p className="text-gray-600 mb-4">
