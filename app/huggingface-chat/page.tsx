...
export default function HuggingFaceChatPage() {
  ...
  const [modelInfo, setModelInfo] = useState("Using Hugging Face model: meta-llama/Llama-2-7b-chat-hf")
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      ...
      <p className="text-sm text-muted-foreground mb-6">{modelInfo}</p>
